...
```{r}
ex() %>%
  check_object("x", undefined_msg = "Make sure to define a variable `x`.") %>%
  check_equal(incorrect_msg = "Make sure that you assign the correct value to `x`.")
...
```{r}
ex() %>%
  check_object("my_apples",  undefined_msg = "Please make sure to define a variable `my_apples`.") %>%
  check_equal(incorrect_msg = "Make sure that you assign the correct value to `my_apples`.")
...
for (obj in c("my_numeric", "my_character", "my_logical")) {
  ex() %>% check_object(obj, undefined_msg = msg) %>% check_equal(incorrect_msg = msg)
}

# Check class() calls
patt <- "Have you included `class(%1$s)` to print out the data type of `%1$s`?"
ex() %>% check_output_expr("class(my_numeric)",
                           missing_msg = "Do not remove the code that prints out the type of `my_numeric`.")
ex() %>% check_output_expr("class(my_character)",
                           missing_msg = sprintf(patt, "my_character"))
ex() %>% check_output_expr("class(my_logical)",
                           missing_msg = sprintf(patt, "my_logical"))
